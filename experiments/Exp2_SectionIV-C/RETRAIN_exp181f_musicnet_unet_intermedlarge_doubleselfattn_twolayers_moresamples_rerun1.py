...
from libdl.nn_models import simple_u_net_doubleselfattn_twolayers
...
# Specify and log model config #################################################
mp = model_params
model = simple_u_net_doubleselfattn_twolayers(n_chan_input=mp['n_chan_input'], n_chan_layers=mp['n_chan_layers'], \
