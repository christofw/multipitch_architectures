...
from libdl.nn_models import simple_u_net_doubleselfattn
...
# Specify and log model config #################################################
mp = model_params
model = simple_u_net_doubleselfattn(n_chan_input=mp['n_chan_input'], n_chan_layers=mp['n_chan_layers'], \
    n_bins_in=mp['n_bins_in'], n_bins_out=mp['n_bins_out'], a_lrelu=mp['a_lrelu'], p_dropout=mp['p_dropout'], \
    scalefac=mp['scalefac'], embed_dim=mp['embed_dim'], num_heads=mp['num_heads'], mlp_dim=mp['mlp_dim'], pos_encoding=mp['pos_encoding'])
...
# test_versions = ['2303_', '1819_', '2382_', '1759_', '2106_', '2191_', '2298_', '2416_', '2556_', '2628_']    # as in paper
# test_versions = ['2302_', '1818_', '2383_', '1758_', '2105_', '2186_', '2293_', '2415_', '2557_', '2627_']    # mainly slow mvmts.
test_versions = ['2310_', '1817_', '2381_', '1757_', '2104_', '2186_', '2296_', '2417_', '2555_', '2626_']    # mainly fast mvmts.
